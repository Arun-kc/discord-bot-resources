...
- [The Coding Train](https://youtube.com/playlist?list=PLRqwX-V7Uu6avBYxeBSwF48YhAnSn_sA4)
- [Worn Off Keys](https://youtube.com/playlist?list=PLaxxQQak6D_fxb9_-YsmRwxfw5PH9xALe)
- [freeCodeCamp (Using python)](https://www.freecodecamp.org/news/create-a-discord-bot-with-python/)

## APIs

- [Advice Slip API](https://api.adviceslip.com/)
- [Bored API](https://www.boredapi.com/)
- [Chucknorris Jokes](https://api.chucknorris.io/)
- [Giphy API](https://developers.giphy.com/docs/api/)
- [Some Random API](https://some-random-api.ml/docs/Examples/NodeJS)
- [Tenor API](https://tenor.com/gifapi/documentation)

## NPM Packages

- [Random Animals](https://www.npmjs.com/package/random-animals-api)
- [Reddit Image Fetcher](https://www.arifszn.com/reddit-image-fetcher/)
